...
/* This function explicits the result of the search, i.e., if a path is found, then it is printed, otherwise a message is printed
that warns of the unreachability of the goal point. */  
